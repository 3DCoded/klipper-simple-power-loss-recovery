...
<!-- I am currently working on a more complex approach of [Power Loss Recovery](https://klipper.discourse.group/t/wip-power-loss-recovery/14478), but while working on that, I made thissimple power loss recovery script in Python, that can recover any print by the last recorded Z height. -->
